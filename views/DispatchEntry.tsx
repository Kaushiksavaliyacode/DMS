                                 ...
                                 <div className="bg-white px-4 py-3 border-b border-slate-100">
                                      ...
                                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                          <div className="flex items-center gap-3 overflow-hidden w-full sm:w-auto">
                                              <span className="text-xs font-bold bg-slate-50 border border-slate-200 px-2 py-1 rounded text-slate-600 whitespace-nowrap">{date}</span>
                                              <h4 className="font-bold text-slate-900 text-base truncate flex-1 sm:flex-none">{party}</h4>
                                              <button 
                                                  onClick={() => sendBulkWhatsApp(items)} 
                                                  className="ml-auto sm:ml-1 bg-emerald-50 text-emerald-600 hover:bg-emerald-50 border border-emerald-200 px-2 py-1 rounded-lg transition-colors flex items-center gap-1 text-[10px] font-bold shrink-0"
                                          ...
                                          <div className="flex justify-end w-full sm:w-auto">
                                               <span className="text-xs font-bold text-slate-700 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded whitespace-nowrap w-full sm:w-auto text-center">Total Bundles: {totalBundles}</span>
                                          </div>
                                      </div>
                                 </div>
