...
// FIX: Removed modular auth imports as we are using the compat library to resolve export errors.
...
const App: React.FC = () => {
  ...
  // --- Auth Subscription ---
  useEffect(() => {
    // FIX: Use the onAuthStateChanged method from the compat auth object.
  ...
  const handleLogout = async () => {
    // FIX: Use the signOut method from the compat auth object.
    await auth.signOut();
  };
